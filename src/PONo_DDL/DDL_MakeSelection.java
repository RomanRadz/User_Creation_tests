...
public class DDL_MakeSelection {
...
//		String login_BTN = "SUBMIT";
//		String createPO_Tab = "/html/body/table[1]/tbody/tr[3]/td/table"
//				+ "/tbody/tr/td/table/tbody/tr/td/div/table/tbody/tr[2]/td"
//				+ "/div/table/tbody[1]/tr/td/table[3]/tbody/tr/td/div/table"
//				+ "/tbody/tr/td[2]/div/table/tbody/tr/td/table/tbody/tr/td"
//				+ "/div/a/b";
//		String poNo_ddl = "POopco";
//		int tormax = 3;
		...
		driver.findElement(By.name("Orderedby")).sendKeys("Possitive Test");
		...
		//Step. Click on Create PO button
		driver.findElement(By.name("submit")).click();
		
		//Find text
		if (driver.getPageSource().contains("Possitive Test")) {
		...
		//Step. Click on Logout hyperlink
